...
Display( )
{
	...
	glStencilFunc(GL_ALWAYS, 0, 0xFF); // Draw first world. Care about depth
	...
	glStencilFunc(GL_EQUAL, 0, 0xFF); // Draw first window as 1
	...
	glStencilFunc(GL_EQUAL, 1, 0xFF); // Draw Second world. Care about depth
	...
	glStencilFunc(GL_EQUAL, 1, 0xFF); // Draw Second window as 3
	glStencilOp(GL_KEEP, GL_KEEP, GL_INCR);
	glDepthFunc(GL_LESS);
	...
	glClear(GL_DEPTH_BUFFER_BIT);
	glStencilFunc(GL_EQUAL, 2, 0xFF); // Draw third world. Care about depth
	glStencilOp(GL_KEEP, GL_KEEP, GL_KEEP);
	glDepthFunc(GL_LESS);
