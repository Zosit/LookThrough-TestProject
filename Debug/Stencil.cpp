...
Display( )
{
	...
	glStencilFunc(GL_LESS, 1, 0xFF); // Set any stencil to 1

	glColor3f(1., 0., 1.);
	glutSolidCube(1);

	glStencilFunc(GL_ALWAYS, 0, 0xFF); // Set any stencil to 1
	...
	glStencilFunc(GL_EQUAL, 2, 0xFF); // Set any stencil to 1
